...
namespace _2_Dev._2_Test
{
    public class TestScreen : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("Center_Point")] [SerializeField]
        ...
        [FormerlySerializedAs("PointList")] [SerializeField]
        private SpriteRenderer[] pointList;
        ...
        private void Start()
        {
            ...
            foreach (var point in pointList) point.transform.SetRelativeSize(1f, 1);
        }
    }
}